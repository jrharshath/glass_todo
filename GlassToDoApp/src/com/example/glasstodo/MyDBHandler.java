...
public class MyDBHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String CREATE_PRODUCTS_TABLE = "CREATE TABLE " +
				 ...
				 + COLUMN_TASKDESCRIPTION + " TEXT," + COLUMN_URGENCY + " INTEGER," + 
	...
	public void addTaskItem(TaskItem item){
        ...
        values.put(COLUMN_TASKDESCRIPTION, item.getTasktext());
	...
	public TaskItem findTaskItem(int tid) {
		...
		if (cursor.moveToFirst()) {
			...
			taskItem.setUrgency(Integer.parseInt(cursor.getString(2)));
			taskItem.setImportance(Integer.parseInt(cursor.getString(3)));
			taskItem.setDeadline(cursor.getString(4));
			taskItem.setTagsBundle(cursor.getString(4));
			cursor.close();
		} else {
			taskItem = null;
		}
	...
	public void updateTaskItem(TaskItem newTask){
		ContentValues values = new ContentValues();
        values.put(COLUMN_TASKDESCRIPTION, newTask.getTasktext());
	...
	public ArrayList<TaskItem> showSimpleTasks() {
		String query = "Select " + COLUMN_ID + "," + COLUMN_TASKDESCRIPTION + " FROM " + TABLE_TASKS;
